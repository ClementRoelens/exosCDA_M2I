...
public class Main {
    ...
    public static void main(String[] args) {
        ArticleService.addArticle(new Ream("Papier A4", 5.99f, (byte) 500));
        ArticleService.addArticle(new Ream("Papier Lettre", 4.99f, (byte) 500));
        ArticleService.addArticle(new Pencil("Crayon HB", 0.99f, "Jaune"));
        ArticleService.addArticle(new Pencil("Crayon 2B", 1.29f, "Noir"));
        Ream legalPaper = new Ream("Papier juridique", 7.49f, (byte) 500);
        ArticleService.addArticle(legalPaper);
        ArticleService.addArticle(new Batch(legalPaper, (short) 2, (byte) 10));
        Pencil redPencil = new Pencil("Crayon Rouge", 1.49f, "Rouge");
        ArticleService.addArticle(redPencil);
        ArticleService.addArticle(new Batch(redPencil, (short) 5, (byte) 5));
        ArticleService.addArticle(new Ream("Papier à Dessin", 9.99f, (byte) 250));
        ArticleService.addArticle(new Pencil("Crayon Bleu", 1.29f, "Bleu"));
        Ream drawingPaper = new Ream("Papier à Dessin Artistique", 11.99f, (byte) 300);
        ArticleService.addArticle(drawingPaper);
        ArticleService.addArticle(new Batch(drawingPaper, (short) 5, (byte) 15));
        Ream watercolorPaper = new Ream("Papier Aquarelle", 14.99f, (byte) 200);
        ArticleService.addArticle(watercolorPaper);
        ArticleService.addArticle(new Pencil("Crayon Vert", 1.19f, "Vert"));
        ArticleService.addArticle(new Batch(watercolorPaper, (short) 3, (byte) 15));
        ...
        tryAddLine(invoiceOne.addLine(5, (byte) 2));
        tryAddLine(invoiceOne.addLine(3, (byte) 1));
        ...
        tryAddLine(invoiceTwo.addLine(6, (byte) 1));
        tryAddLine(invoiceTwo.addLine(9, (byte) 2));
        tryAddLine(invoiceTwo.addLine(1, (byte) 4));
        ...
        for (Article article : ArticleService.getAllArticles().values()) {
            tryAddLine(invoiceThree.addLine(article.getId(), (byte) 1));
        }
