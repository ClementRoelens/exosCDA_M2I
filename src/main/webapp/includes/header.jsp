...
<header>
    <nav class="navbar bg-dark">
        <div class="container-fluid">
            ...
            <h4 class="text-light">
                Bonjour ${(cookie["isLogged"].getValue() != null) ? cookie["isLogged"].getValue() : "visiteur"} !</h4>
            <ul class="navbar nav">
                <c:choose>

                    <c:when test="${cookie['isLogged'].getValue() != null}">
                        <li class="nav-item"><a class="nav-link text-light" href="logout">Se déconnecter</a></li>
                        <li class="nav-item"><a href="patient-form" class="nav-link text-light">Créer un patient</a></li>
                    </c:when>
                    <c:otherwise>
                ...
                <li class="nav-item"><a href="patient" class="nav-link text-light">Liste des patients</a></li>
            </ul>
        </div>
    </nav>
</header>